# Pet Clinic (the sprint sample web application) using Java and Spring

This tutorial uses JBehave 3.x and Selenium 2.x to test [petclinic](http://petclinic.cloudapp.net/)
...
6. src/main/resources/pet-clinic-steps.xml contains the Spring configuration for composition the steps
