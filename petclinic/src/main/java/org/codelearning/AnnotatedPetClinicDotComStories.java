...
@UsingSpring(resources = {"pet-clinic-steps.xml"})
public class AnnotatedPetClinicDotComStories extends InjectableEmbedder {

    public AnnotatedPetClinicDotComStories() {
    }
